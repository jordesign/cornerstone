	...
	public function preflight_check() {
		...
		if ( is_multisite() && pb_backupbuddy::$classes['core']->is_network_activated() && !defined( 'PB_DEMO_MODE' ) ) { // Multisite installation.
			$tests[] = array(
				'test'		=>	'multisite_beta',
				'success'	=>	false,
				'message'	=>	'DO NOT USE EXPERIMENTAL BACKUPBUDDY MULTISITE BETA ON LIVE SITES:
								Multisite functionality is experimental BETA and is not supported. It is for preview or experimental use only. It is not for use on live sites.
