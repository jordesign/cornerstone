...
class pb_backupbuddy_actions extends pb_backupbuddy_actionscore {
	...
	function multisite_network_warning() {
		pb_backupbuddy::alert( 'BackupBuddy Multisite support is experimental beta software and should NOT be used on live sites. BackupBuddy should be <a href="' . esc_url( admin_url( 'network/plugins.php' ) ) . '">Network Activated</a> when installed on a Multisite Network.', true );
	}
