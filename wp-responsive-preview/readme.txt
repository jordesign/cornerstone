...
1. An example of a site within the WP Responsive Preview frame. Buttons at top left allow you to set size ranges.
2. Location of the Responsive Preview buttons within the editor, and the admin bar.
